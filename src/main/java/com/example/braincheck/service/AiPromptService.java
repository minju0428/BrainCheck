...
public class AiPromptService {
    ...
    public String analyzePersuasionEvidence(
            ...
            String evidenceText,
            int currentRound,
            List<String> previousRoundsEvidence) {
        ...
        try {
            ...
            // 이전 라운드 설득문 구성
            StringBuilder previousRoundsSection = new StringBuilder();
            if (previousRoundsEvidence != null && !previousRoundsEvidence.isEmpty()) {
                previousRoundsSection.append("--- 이전 라운드 설득문 ---\n");
                for (int i = 0; i < previousRoundsEvidence.size(); i++) {
                    previousRoundsSection.append(String.format("라운드 %d: %s\n", i + 1, previousRoundsEvidence.get(i)));
                }
                previousRoundsSection.append("-------------------\n\n");
            }
            ...
            String prompt = String.format(
                    ...
                    aiMbtiType,
                    currentRound,
                    previousRoundsSection.toString(),
                    evidenceText
            );
