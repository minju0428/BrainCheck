...
AI와 함께 작품 속 캐릭터의 심리를 해부하고, 자신의 해석을 논리적으로 검증하는 **인터랙티브 분석 프로그램**입니다.

---

## 📘 프로젝트 개요

**MBTI 퍼센테이지: 뇌피셜 검증소 (Brain Check)**는 책·드라마·영화 속 등장인물의 행동과 가치관을 기반으로 **MBTI를 예측하고**, AI가 제시한 분석과 비교하여 **설득 대결(Persuasion Battle)**을 펼치는 지적 게임형 웹 애플리케이션입니다.
...
* 사용자 입력 논거 → AI 점수 반영
* 설득률 누적 및 히스토리 기록
* 3라운드 종료 또는 100% 달성 시 다음 차원으로 이동
* 모든 차원 완료 시 대결 종료 처리
